...
<header>
	<a href="/procure/home"><img src="/resources/img/nullimg_bm.png"
		height=50px class="brand_logo" alt="Logo"></a>
	<nav>
		<ul>

			<li><a href="/procure/partner">관리메뉴</a></li>
			<li><a href="#">판매메뉴</a></li>
			<li><a href="#">제조메뉴</a></li>
...
<body>
	<div>
		<input type="checkbox" id="menuicon" checked="checked"> <label
		...
		<div class="sidebar">
			<div id=sidemenu>
				...
				<ul>
					...
					<br>
					<li><a href="/procure/iteminfo">품목 등록 정보</a></li>
					<br>
					<li><a href="#">계약 등록</a></li>
					<br>
					<li><a href="#">조달 계획 등록</a></li>
					<br>
				</ul>
				<br>
				<ul>
